package com.nttdata.bootcamp.credittransactionservice.infrastructure.service;

import com.nttdata.bootcamp.credittransactionservice.application.service.CreditService;
...
public class CreditWebService implements CreditService {
    ...
    public CreditWebService(WebClient.Builder webClientBuilder,
                            @Value("${credit.web.url: http://credit-service/accounts}") String URI) {
